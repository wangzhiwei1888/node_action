...
router.get('/getJobs', function (req, res, next) { // 浏览器端发来get请求
    let page = req.param('page');  //获取get请求中的参数 page
    console.log("page: " + page);
    let Res = res;  //保存，防止下边的修改
    //url 获取信息的页面部分地址
    let url = 'http://www.lagou.com/jobs/list_%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91?kd=%E5%89%8D%E7%AB%AF%E5%BC%80%E5%8F%91&spc=1&pl=&gj=&xl=&yx=&gx=&st=&labelWords=label&lc=&workAddress=&city=%E5%85%A8%E5%9B%BD&requestId=&pn=';
