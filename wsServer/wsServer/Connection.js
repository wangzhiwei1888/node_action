...
const InStream = require('./InStream.js');
const OutStream = require('./OutStream.js');
...
class Connection extends EventEmitter {
    constructor(socket, parentOrOptions, callback) {
        super();
        ...
        if (!this.server) {
            let connectEvent = socket.constructor.name === 'CleartextStream' ? 'secureConnect' : 'connect';
